...
(function($) {
    ...
    FullscreenTextarea.prototype.init = function (opts) {
        ...
        content =
            '<div class="tx-editor-wrapper"><div class="tx-editor">' +
            '<a href="#" class="tx-icon"></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'# Header\\n\');return false;"><span class="glyphicon glyphicon-header">1</span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'## Header\\n\');return false;"><span class="glyphicon glyphicon-header">2</span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'### Header\\n\');return false;"><span class="glyphicon glyphicon-header">3</span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'[Link text](https://)\');return false;"><span class="glyphicon glyphicon-link"></span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'![Image text](https://)\');return false;"><span class="glyphicon glyphicon-picture"></span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'**Bold**\');return false;"><span class="glyphicon glyphicon-bold"></span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'*Italic*\');return false;"><span class="glyphicon glyphicon-italic"></span></a>' +
            ' <a style="color: #D4D4D4" href="#" onclick="insertAtCaret(\'body\', \'* Item\\n\');return false;"><span class="glyphicon glyphicon-list"></span></a>' +
            '</div></div>';
    ...
    FullscreenTextarea.prototype.showOverlay = function () {
        ...
        let nav = document.getElementsByClassName("navvy")[0];
