...
button.addEventListener('click', function (e) {
    ...
    var newTab = window.open('about:blank','Keepsake - Blackboard Image');
    newTab.document.write('<!DOCTYPE html><body><img src="'+ dataURL +'"></body></html>');
    ...
    switch (message.kind) {
        case MESSAGE_CONNECTED:
            for (var i = 0; i < message.users.length; i++) {
                ...
                if (user.id == getCookie("gowiki_username")) {
